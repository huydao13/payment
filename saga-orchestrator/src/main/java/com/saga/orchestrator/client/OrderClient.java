...
public class OrderClient {
    ...
    @Value("${services.order.url}/api/orders")
    ...
    public ServiceResponse createOrder(SagaState saga, boolean simulateFail) {
        ...
        OrderRequest request = OrderRequest.builder()
                ...
                .build();
        try {
            return restTemplate.postForObject(baseUrl + "/create", request, ServiceResponse.class);
        } catch (Exception e) {
    ...
    public ServiceResponse cancelOrder(String sagaId) {
        ...
        try {
            return restTemplate.postForObject(baseUrl + "/cancel/" + sagaId, null, ServiceResponse.class);
        } catch (Exception e) {
    ...
    public ServiceResponse confirmOrder(String sagaId) {
        ...
        try {
            return restTemplate.postForObject(baseUrl + "/confirm/" + sagaId, null, ServiceResponse.class);
        } catch (Exception e) {
